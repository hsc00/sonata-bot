...
async def create_profile_embed(ctx, user_id, username, link):
    ...
    average_rating, ratings_number, ratings_chart, most_rated_decade, most_rated_year, best_rated_decade, best_rated_year, worst_rated_decade, worst_rated_year = get_rym_user_info(ctx, user_id)
    ...
    if ratings_number < 1:
        ...
        embed_description += f"\nWorst Rated Decade • **{worst_rated_decade}**\nWorst Rated Year • **{worst_rated_year}**"
